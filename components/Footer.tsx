...
const socials = [
  {
    label: "Instagram",
    href: "https://instagram.com/clubhonbu",
    icon: (
  ...
  {
    label: "TikTok",
    href: "https://tiktok.com/@clubhonbu",
    icon: (
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@clubhonbu",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  {
    label: "Threads",
    href: "https://threads.net/@clubhonbu",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.028-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.589 12c.027 3.086.718 5.496 2.057 7.164 1.43 1.783 3.631 2.698 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.31-.71-.873-1.3-1.634-1.75-.192 1.352-.622 2.446-1.284 3.272-.886 1.102-2.14 1.704-3.73 1.79-1.202.065-2.361-.218-3.259-.801-1.063-.689-1.685-1.74-1.752-2.964-.065-1.19.408-2.285 1.33-3.082.88-.76 2.119-1.207 3.583-1.291a13.853 13.853 0 0 1 3.02.142c-.126-.742-.375-1.332-.75-1.757-.513-.583-1.279-.88-2.27-.887h-.064c-.752 0-1.77.141-2.816 1.167l-1.42-1.464C9.385 4.53 10.804 4 12.08 4h.1c1.496.01 2.72.518 3.54 1.47.724.839 1.154 2.01 1.277 3.484a10.78 10.78 0 0 1 1.496.657c1.254.68 2.174 1.63 2.661 2.746.79 1.829.803 4.836-1.523 7.107-1.763 1.718-3.964 2.517-7.048 2.536h-.397z" />
        <path d="M11.937 14.875c.842-.045 1.467-.327 1.86-.838.367-.477.573-1.162.612-2.036a11.54 11.54 0 0 0-2.495-.115c-.973.057-1.71.33-2.126.775-.344.37-.5.847-.463 1.38.04.707.402 1.18.964 1.547.517.335 1.145.324 1.648.287z" />
      </svg>
    ),
  },
  {
    label: "Facebook",
    href: "https://facebook.com/clubhonbu",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export function Footer() {
  return (
    <footer className="border-t border-line mt-24">
      <div className="container-page py-12 flex flex-col gap-8">
